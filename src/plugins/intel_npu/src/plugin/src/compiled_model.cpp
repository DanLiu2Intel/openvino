...
void CompiledModel::configure_stream_executors() {
    std::cout << "=== NPU CompiledModel configure_stream_executors 1===" << std::endl;
    std::cout << networkMetadataToString(_graph->get_metadata()) << std::endl;
    std::cout << "=== NPU CompiledModel configure_stream_executors 2===" << std::endl;

...
std::unordered_set<std::string> LevelZeroCompilerInDriver<TableExtension>::queryImpl(IR& irModel,
                                                                                     const Config& config) const {
    _logger.info("queryImpl - Calling queryNetwork of 1.5 version.");

...
class InferRequestElementTypeTests : public testing::WithParamInterface<NPUInferRequestElementTypeParams>,
...
<net name="custom_model" version="11">
    ...
    std::cout << "test dynamicTypeModelXmlStream output before Serialize: \n" << dynamicTypeModelXmlStream.str() << std::endl;
    std::cout << "test undefinedTypeModelXmlStream output before Serialize: \n" << undefinedTypeModelXmlStream.str() << std::endl;
    ...
    std::cout << "test dynamicTypeModelXmlStream output after Serialize: \n" << dynamicTypeModelXmlStream.str() << std::endl;
    std::cout << "test undefinedTypeModelXmlStream output after Serialize: \n" << undefinedTypeModelXmlStream.str() << std::endl;

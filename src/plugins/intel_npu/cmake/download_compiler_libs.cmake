...
if(ENABLE_INTEL_NPU_COMPILER)
    ...
    if(WIN32)
        ...
        set(PLUGIN_VM_RUNTIME_COMPILER_LIB_NAME "npu_interpreter_runtime.dll")
        set(PLUGIN_VM_RUNTIME_COMPILER_PDB_NAME "npu_interpreter_runtime.pdb")
    elseif(UNIX AND NOT APPLE AND NOT ANDROID)
        ...
        if(OS_NAME STREQUAL "Ubuntu" AND (OS_VERSION STREQUAL "22.04" OR OS_VERSION STREQUAL "24.04"))
            ...
            set(PLUGIN_VM_RUNTIME_COMPILER_LIB_NAME "libnpu_interpreter_runtime.so")
        else()
    ...
    if(NPU_PLUGIN_COMPILER)
        ...
        set(PLUGIN_VM_RUNTIME_COMPILER_LIB "${PLUGIN_COMPILER_LIB_PATH}/${PLUGIN_VM_RUNTIME_COMPILER_LIB_NAME}")
        ...
        file(COPY "${PLUGIN_VM_RUNTIME_COMPILER_LIB}" DESTINATION "${PLUGIN_COMPILER_LIB_DESTINATION}")
        ...
        message(STATUS "Copying prebuilt Plugin VM runtime compiler library ${PLUGIN_COMPILER_LIB_PATH}/${PLUGIN_VM_RUNTIME_COMPILER_LIB_NAME} to ${PLUGIN_COMPILER_LIB_DESTINATION}")
        ...
        if(WIN32)
            ...
            set(PLUGIN_VM_RUNTIME_COMPILER_PDB "${PLUGIN_COMPILER_PDB_PATH}/${PLUGIN_VM_RUNTIME_COMPILER_PDB_NAME}")
            ...
            file(COPY "${PLUGIN_VM_RUNTIME_COMPILER_PDB}" DESTINATION "${PLUGIN_COMPILER_LIB_DESTINATION}")
